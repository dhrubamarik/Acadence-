...
def send_otp_email(user_email, otp):
    ...
    <div style="font-family: Inter, Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #f8f9ff; border-radius: 16px;">
        <div style="text-align: center; margin-bottom: 24px;">
            <h1 style="color: #6366f1; font-size: 28px; margin: 0;">🎓 Acadence</h1>
            <p style="color: #9ca3af; margin: 4px 0 0; font-size: 14px;">AI Academic Stress Forecaster</p>
        </div>
        <div style="background: white; border-radius: 12px; padding: 28px; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.06);">
            ...
            <p style="color: #6b7280; margin: 0 0 24px; font-size: 14px;">Use this OTP to complete your Acadence registration.</p>
            <div style="background: #f0f4ff; border: 2px dashed #6366f1; border-radius: 12px; padding: 24px; margin: 0 0 24px;">
                <p style="margin: 0 0 6px; font-size: 11px; color: #9ca3af; text-transform: uppercase; letter-spacing: 3px;">Your OTP Code</p>
                <p style="margin: 0; font-size: 46px; font-weight: 800; color: #6366f1; letter-spacing: 14px;">{otp}</p>
            </div>
            <div style="background: #fffbeb; border: 1px solid #fde68a; border-radius: 8px; padding: 12px; margin-bottom: 16px;">
                <p style="margin: 0; font-size: 13px; color: #d97706;">⏰ Valid for <strong>10 minutes</strong> only</p>
            </div>
            <p style="color: #9ca3af; font-size: 13px; margin: 0;">🔒 Never share this OTP with anyone</p>
        </div>
        <p style="text-align: center; color: #d1d5db; font-size: 12px; margin-top: 20px;">If you didn't register on Acadence, ignore this email.</p>
    </div>
    """)
...
def login(request):
    ...
    # Not verified - resend OTP safely
